...
class _HomePageState extends State<HomePage> {
  ...
  List<Band> bands =  [
    Band(id: '1', name: 'U2', votes: 0),
    Band(id: '2', name: 'Coldplay', votes: 3),
    Band(id: '3', name: 'The Animal', votes: 5),
    Band(id: '4', name: 'Daft Punk', votes: 9),
    Band(id: '5', name: 'Alan Walker', votes: 2),
  ];
  ...
  Widget _buildTile(Band band) {
    return Dismissible(
          ...
          onDismissed: (direction){
            ...
            //To do, llamar el borrado en el server
          },
